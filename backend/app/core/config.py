...
class Settings(BaseSettings):
    ...
    AI_ANALYSIS_REPORT_ALLOW_BAIZHI_TEST: bool = False
    AI_ANALYSIS_REPORT_SYNTHETIC_MANIFEST: str = "[]"
    AI_ANALYSIS_REPORT_TIMEOUT_SECONDS: float = Field(default=120, gt=0, le=600)
