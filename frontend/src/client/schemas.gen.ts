...
export const AiDraftEditedFindingSchema = {
    properties: {
        finding_id: {
            type: 'string',
            maxLength: 36,
        ...
        rescan_recommendation: {
            type: 'string',
            maxLength: 4000,
            minLength: 1,
            title: 'Rescan Recommendation'
        },
    ...
    type: 'object',
    required: ['finding_id', 'rescan_recommendation'],
    title: 'AiDraftEditedFinding'
} as const;

export const AiDraftEditedOutputSchema = {
    properties: {
        findings: {
            items: {
                '$ref': '#/components/schemas/AiDraftEditedFinding'
            },
            type: 'array',
            maxItems: 8,
            minItems: 1,
...
export const AiDraftModelClaimSchema = {
    properties: {
        claim_id: {
            type: 'string',
            maxLength: 100,
    ...
    title: 'AiDraftModelClaim'
} as const;

export const AiDraftModelOutputSchema = {
    properties: {
        report_sha256: {
            type: 'string',
            pattern: '^[0-9a-f]{64}$',
        ...
        recommendations: {
            items: {
                '$ref': '#/components/schemas/AiDraftRecommendation'
            },
            type: 'array',
            maxItems: 8,
            minItems: 1,
    ...
    additionalProperties: false,
    type: 'object',
    required: ['report_sha256', 'summary', 'recommendations'],
    title: 'AiDraftModelOutput'
} as const;

export const AiDraftRecommendationSchema = {
    properties: {
        finding_id: {
            type: 'string',
            maxLength: 36,
        ...
        claims: {
            items: {
                '$ref': '#/components/schemas/AiDraftModelClaim'
            },
            type: 'array',
            maxItems: 8,
            minItems: 1,
    ...
    additionalProperties: false,
    type: 'object',
    required: ['finding_id', 'rescan_recommendation', 'claims'],
    title: 'AiDraftRecommendation'
} as const;
...
export const AiGovernanceDraftReviewDecisionSchema = {
    type: 'string',
    enum: ['ACCEPTED', 'EDITED', 'REJECTED'],
    title: 'AiGovernanceDraftReviewDecision'
} as const;

export const AiGovernanceDraftReviewPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
        ...
        model_output: {
            anyOf: [
                {
                    '$ref': '#/components/schemas/AiDraftModelOutput'
                },
                {
                    type: 'null'
                }
        ...
        operator_edited_output: {
            anyOf: [
                {
                    '$ref': '#/components/schemas/AiDraftEditedOutput'
                },
                {
                    type: 'null'
                }
        ...
        generation_terminal_at: {
            ...
            title: 'Generation Terminal At'
        }
    },
    type: 'object',
    required: ['id', 'governance_report_id', 'report_sha256', 'status', 'failure_code', 'agent_compose_run_id', 'session_id', 'created_at', 'governance_run_id'],
    title: 'AiGovernanceDraftReviewPublic'
} as const;

export const AiGovernanceDraftReviewRequestSchema = {
    properties: {
        decision: {
            '$ref': '#/components/schemas/AiGovernanceDraftReviewDecision'
        },
    ...
    type: 'object',
    required: ['decision'],
    title: 'AiGovernanceDraftReviewRequest'
} as const;
