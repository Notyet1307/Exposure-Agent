...
export const AiGovernanceDraftReviewPublicSchema = {
    ...
    description: 'The persisted terminal review projection, including immutable output.'
} as const;
...
export const AiGovernanceDraftReviewRequestSchema = {
    ...
    description: 'The deliberately narrow public contract for a terminal review.'
} as const;
