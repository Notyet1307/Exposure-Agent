...
export class CustomerLedgerService {
     ...
     * @param data.skip
     * @param data.limit
     * @returns LedgerPage Successful Response
     * @throws ApiError
     */
    public static readCustomerLedger(data: CustomerLedgerReadCustomerLedgerData): CancelablePromise<CustomerLedgerReadCustomerLedgerResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/projects/{project_id}/customer-ledger',
            path: {
                project_id: data.projectId
            },
            query: {
    ...
    /**
     * Read Customer Ledger Revisions
     * @param data The data for the request.
     * @param data.projectId
     * @param data.skip
     * @param data.limit
     * @returns app__domain__customer_ledger__RevisionPublic Successful Response
     * @throws ApiError
     */
    public static readCustomerLedgerRevisions(data: CustomerLedgerReadCustomerLedgerRevisionsData): CancelablePromise<CustomerLedgerReadCustomerLedgerRevisionsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/projects/{project_id}/customer-ledger/revisions',
            path: {
                project_id: data.projectId
            },
            query: {
    ...
    /**
     * Create Customer Ledger Revision
     * @param data The data for the request.
     * @param data.projectId
     * @param data.idempotencyKey
     * @param data.requestBody
     ...
     * @throws ApiError
     */
    public static createCustomerLedgerRevision(data: CustomerLedgerCreateCustomerLedgerRevisionData): CancelablePromise<CustomerLedgerCreateCustomerLedgerRevisionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/projects/{project_id}/customer-ledger/revisions',
            path: {
    ...
    /**
     * Read Customer Ledger Operation
     * @param data The data for the request.
     * @param data.projectId
     * @param data.operationKey
     * @returns app__domain__customer_ledger__RevisionPublic Successful Response
     * @throws ApiError
     */
    public static readCustomerLedgerOperation(data: CustomerLedgerReadCustomerLedgerOperationData): CancelablePromise<CustomerLedgerReadCustomerLedgerOperationResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/projects/{project_id}/customer-ledger/operations/{operation_key}',
            path: {
                project_id: data.projectId,
                operation_key: data.operationKey
            },
...
export class ModelConnectionsService {
    /**
     * Status
     * @returns ConnectionStatus Successful Response
     * @throws ApiError
     */
    public static status(): CancelablePromise<ModelConnectionsStatusResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/model-connections/status'
        });
    }
    
    /**
     * Read Connections
     * @returns ConnectionStatePublic Successful Response
     * @throws ApiError
     */
    public static readConnections(): CancelablePromise<ModelConnectionsReadConnectionsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @param data.idempotencyKey
     * @param data.requestBody
     * @returns ConnectionActionPublic Successful Response
     * @throws ApiError
     */
    public static save(data: ModelConnectionsSaveData): CancelablePromise<ModelConnectionsSaveResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/model-connections',
            headers: {
     ...
     * @throws ApiError
     */
    public static adoptLegacy(data: ModelConnectionsAdoptLegacyData): CancelablePromise<ModelConnectionsAdoptLegacyResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/model-connections/adopt-legacy',
            headers: {
                'Idempotency-Key': data.idempotencyKey
            },
            body: data.requestBody,
     ...
     * @throws ApiError
     */
    public static action(data: ModelConnectionsActionData): CancelablePromise<ModelConnectionsActionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/model-connections/{connection_id}/{action}',
            path: {
     ...
     * @throws ApiError
     */
    public static recoverOperation(data: ModelConnectionsRecoverOperationData): CancelablePromise<ModelConnectionsRecoverOperationResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/model-connections/operations/recover/{action}',
            path: {
                action: data.action
            },
            headers: {
     ...
     * @throws ApiError
     */
    public static operation(data: ModelConnectionsOperationData): CancelablePromise<ModelConnectionsOperationResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/model-connections/operations/{operation_id}',
            path: {
...
export class NetflowLedgerService {
    /**
     * Read Netflow Ledger
     * @param data The data for the request.
     * @param data.projectId
     ...
     * @throws ApiError
     */
    public static readNetflowLedger(data: NetflowLedgerReadNetflowLedgerData): CancelablePromise<NetflowLedgerReadNetflowLedgerResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/projects/{project_id}/netflow-ledger',
            path: {
                project_id: data.projectId
            },
            query: {
    ...
    /**
     * Create Netflow Ledger Revision
     * @param data The data for the request.
     * @param data.projectId
     * @param data.idempotencyKey
     * @param data.requestBody
     * @returns app__domain__netflow_ledger__RevisionPublic Successful Response
     * @throws ApiError
     */
    public static createNetflowLedgerRevision(data: NetflowLedgerCreateNetflowLedgerRevisionData): CancelablePromise<NetflowLedgerCreateNetflowLedgerRevisionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/projects/{project_id}/netflow-ledger/revisions',
            path: {
                project_id: data.projectId
            },
            headers: {
     ...
     * @throws ApiError
     */
    public static readNetflowLedgerRevisions(data: NetflowLedgerReadNetflowLedgerRevisionsData): CancelablePromise<NetflowLedgerReadNetflowLedgerRevisionsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/projects/{project_id}/netflow-ledger/revisions',
            path: {
     ...
     * @throws ApiError
     */
    public static readNetflowLedgerOperation(data: NetflowLedgerReadNetflowLedgerOperationData): CancelablePromise<NetflowLedgerReadNetflowLedgerOperationResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/projects/{project_id}/netflow-ledger/operations/{operation_key}',
            path: {
                project_id: data.projectId,
                operation_key: data.operationKey
            },
     ...
     * @param data.customerRevisionId
     * @param data.snapshotId
     * @param data.cloudRevision
     * @returns Profile Successful Response
     * @throws ApiError
     */
    public static readNetflowLedgerProfile(data: NetflowLedgerReadNetflowLedgerProfileData): CancelablePromise<NetflowLedgerReadNetflowLedgerProfileResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/projects/{project_id}/netflow-ledger/profile',
            path: {
                project_id: data.projectId
            },
            query: {
                ...
                customer_revision_id: data.customerRevisionId,
                snapshot_id: data.snapshotId,
                cloud_revision: data.cloudRevision
            },
            errors: {
                422: 'Validation Error'
            }
