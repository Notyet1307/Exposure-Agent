...
for name in (
    ...
    "AI_INVESTIGATION_TIMEOUT_SECONDS",
    "AI_INVESTIGATION_FOLLOWUP_TIMEOUT_SECONDS",
    "AI_INVESTIGATION_MAX_TOOL_CALLS",
    "AI_INVESTIGATION_MAX_MATERIAL_BYTES",
    "AI_INVESTIGATION_MAX_OUTPUT_BYTES",
    "AI_ANALYSIS_REPORT_ALLOW_BAIZHI_TEST",
    "AI_ANALYSIS_REPORT_SYNTHETIC_MANIFEST",
    "AI_ANALYSIS_REPORT_TIMEOUT_SECONDS",
    "AI_ANALYSIS_REPORT_MAX_TOOL_CALLS",
    "AI_ANALYSIS_REPORT_MAX_MATERIAL_BYTES",
