...
runServiceMain(defineService({
  handlers: {
    "cloudatlas.assets.v1.CloudAtlasAssetsService/ListIPAssets": (ctx) => invoke(ctx, "ip"),
    "cloudatlas.assets.v1.CloudAtlasAssetsService/ListPortServices": (ctx) => invoke(ctx, "port"),
  },
}));
